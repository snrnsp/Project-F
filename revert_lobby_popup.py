...
target_routine = '''        private IEnumerator DelayedNewGameRoutine(Theme.ScreenTransition transition)
        {
...
replacement_routine = '''        private IEnumerator DelayedNewGameRoutine(Theme.ScreenTransition transition, GameObject popupOverlay)
        {
            float fadeTime = 2.2f; // 0.3s faster than previous 2.5f
            float waitTime = 2.0f; // 2 seconds wait on black screen
...
print('Reverted popup destruction timing')
