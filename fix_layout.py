...
# We need to replace the layout code for triObj, iconObj, and msgObj.
# It's better to just write a focused regex replacement for the layout parts.
...
new_layout = '''
            ...
            msgRt.offsetMin = new Vector2(50, 0);
            msgRt.offsetMax = new Vector2(-50, 0);
            TextMeshProUGUI msgText = Theme.UIHelper.AddText(msgObj,
                ...
                $"<b>{warn}\uD63C\uB780{warnEnd}</b>, " +
                $"\uB610\uB294 <b>{warn}\uC77C\uC2DC\uC801\uC778 \uC758\uC2DD \uC0C1\uC2E4{warnEnd}</b> \uB4F1\uC758 \uC99D\uC0C1\uC744 \uACA겪\uB294\uB2E4\uBA74 " +
