...
namespace HalloweenVN.UI.Theme
{
    public static class HalloweenTheme
    {
        ...
        public static readonly Color PanelBackground = new Color32(30, 15, 45, 220);       // dark purple, semi-transparent
        ...
        // Buttons
        public static readonly Color ButtonNormal = new Color32(50, 25, 70, 230);          // dark purple
        ...
        public static readonly Color ButtonDisabled = new Color32(40, 40, 40, 180);        // gray
        public static readonly Color ButtonText = new Color32(255, 180, 80, 255);          // warm gold
        
        // Evidence / Deduction
        public static readonly Color SlotEmpty = new Color32(35, 30, 50, 180);             // dark purple-gray
        public static readonly Color SlotFilled = new Color32(50, 80, 50, 200);            // muted green
        public static readonly Color SlotHighlight = new Color32(180, 100, 20, 200);       // amber highlight
        public static readonly Color InventoryBg = new Color32(20, 12, 30, 230);           // very dark
